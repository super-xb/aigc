<template>
  <div class="app">
    ...
    <nav class="navbar">
      <div class="navbar-left">
        ...
        <div class="nav-links">
          ...
          <a href="#demo" class="nav-link">Book a Demo</a>
        </div>
      </div>

      <div class="navbar-right">
        <a href="#" class="nav-link" @click="showLoginModal = true">Log in</a>
    ...
    <div class="mobile-menu" :class="{ 'open': mobileMenuOpen }">
      ...
      <a href="#contact" class="mobile-link">Contact Sales</a>
      <a href="#demo" class="mobile-link">Book a Demo</a>
      <a href="#" class="mobile-link" @click="showLoginModal = true">Log in</a>
      <button class="btn-primary mobile-btn">Start for Free</button>
    </div>
    ...
    <section class="hero">
      <div class="container">
        <h1 class="hero-title">
          One Subscription for All<br>
          AI Visual Tools
        </h1>
        <p class="hero-subtitle">
          Save Time and Money: No More Switching Between Expensive AI Design Apps
        </p>
        <button class="hero-button">
          Start for <strong>FREE</strong> today
        </button>
      </div>
    </section>
        ...
        <div class="tools-container">
          ...
          <div class="tool-card tool-image-to-image">
            <div class="tool-header">
              ...
              <h3 class="tool-name">Image-to-Image</h3>
            </div>
          ...
          <div class="tool-card tool-text-to-image">
            <div class="tool-header">
              ...
              <h3 class="tool-name">Text-to-Image</h3>
            </div>
            <div class="tool-content">
              <div class="demo-container">
                <div class="text-prompt">
                  <p>Delicious Fried<br>Cheese Stuffed<br>Doritos</p>
                </div>
                <div class="transform-arrow">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="tool-card tool-consistent-character">
            <div class="tool-header">
              ...
              <h3 class="tool-name">Consistent Character</h3>
            </div>
            <div class="tool-content">
          ...
          <div class="tool-card tool-image-to-video">
            <div class="tool-header">
              ...
              <h3 class="tool-name">Image-to-Video</h3>
            </div>
            <div class="tool-content">
          ...
          <!-- Row 2 -->
          <div class="tool-card tool-insert-object">
            <div class="tool-header">
              <div class="tool-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <h3 class="tool-name">Insert Object</h3>
            </div>
            <div class="tool-content">
              <div class="demo-container">
                <div class="before-image">
          ...
          <div class="tool-card tool-ai-eraser">
            <div class="tool-header">
              <div class="tool-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="m20 20-6-6m2-4a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" />
                </svg>
              </div>
              <h3 class="tool-name">AI Eraser</h3>
            </div>
            <div class="tool-content">
          ...
          <div class="tool-card tool-expand">
            <div class="tool-header">
              <div class="tool-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="tool-card tool-enhance">
            <div class="tool-header">
              <div class="tool-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="m2 12 5.25 5 2-2-5.3-5.3a1 1 0 0 0-1.4 0l-.55.6a1 1 0 0 0 0 1.7Z" />
                  <path d="M15 12 9 6l-2 2 6 6 2-2Z" />
                  <path
                    d="m22 12-5.3-5.3a1 1 0 0 0-1.4 0l-5.3 5.3 2 2 5.25-5 4.25 4a1 1 0 0 0 1.4-.3l.6-.5a1 1 0 0 0-.5-1.2Z" />
                </svg>
              </div>
              <h3 class="tool-name">Enhance</h3>
            </div>
            <div class="tool-content">
        ...
        <div class="feature-container">
          ...
          <div class="feature-content">
            ...
            <p class="feature-description">
              Transform your portrait or photo to cartoon with our <strong>AI Filter</strong>. Dzine (formerly Stylar
      ...
      <section class="feature-section feature-section-reverse">
        <div class="feature-container">
          ...
          <div class="feature-content">
            ...
            <p class="feature-description">
              Generatively merge different elements into one complete image, and make them all match in style. Dzine
          ...
          <div class="feature-content">
            ...
            <p class="feature-description">
              Remove backgrounds from your images with perfect precision using our <strong>AI Background
                Remover</strong>. Dzine (formerly Stylar AI) preserves fine details like hair and transparent elements.
            </p>
          ...
          <div class="feature-content">
            ...
            <p class="feature-description">
              Transform low-quality images into crystal-clear, high-resolution visuals with our <strong>AI Image
                Enhancer</strong>. Dzine (formerly Stylar AI) uses advanced upscaling technology to restore details.
            </p>
      ...
      <section class="feature-section">
        <div class="feature-container">
          ...
          <div class="feature-content">
            ...
            <p class="feature-description">
              Turn your ideas into stunning visuals with just a text prompt. Our <strong>AI Text to Image</strong>
              generator creates unique, high-quality images that match your descriptions perfectly.
            </p>
        ...
        <div class="feature-container">
          ...
          <div class="feature-content">
            ...
            <p class="feature-description">
              ...
              Dzine (formerly Stylar AI) seamlessly extends your images while maintaining visual consistency.
            </p>
    ...
    <section class="features">
      <h2 class="section-title">Why Choose Dzine.ai?</h2>
      ...
      <div class="features-grid">
        <div class="feature-card">
          ...
          <p class="feature-description">Generate high-quality visuals in seconds, not minutes or hours</p>
        </div>
        ...
        <div class="feature-card">
          ...
          <p class="feature-description">Create studio-quality visuals without professional skills</p>
        </div>
        ...
        <div class="feature-card">
          ...
          <p class="feature-description">One subscription for all tools, saving you hundreds of dollars</p>
        </div>
      </div>
    </section>
    ...
    <section class="use-cases-section">
      <div class="container">
        <h2 class="use-cases-title">Best Ways to Use Dzine AI Image Editor</h2>
        <p class="use-cases-subtitle">What do the pros create with Dzine (formerly Stylar AI)?</p>
      ...
      <div class="testimonials-grid">
        <div class="testimonial-card">
          <div class="testimonial-content">
            "Dzine.ai has completely transformed our creative workflow. We're producing content in minutes that used to
            take hours."
          </div>
        ...
        <div class="testimonial-card">
          <div class="testimonial-content">
            "The quality of images I can create with Dzine.ai is incredible. It's like having a professional designer on
            call 24/7."
          </div>
          <div class="testimonial-author">
            <div class="testimonial-avatar"></div>
        ...
        <div class="testimonial-card">
          <div class="testimonial-content">
            "We've cut our design costs by 70% while increasing our output. The ROI with Dzine.ai is simply unmatched."
          </div>
          <div class="testimonial-author">
            <div class="testimonial-avatar"></div>
            <div class="testimonial-info">
    ...
    <section class="cta">
      ...
      <p class="cta-subtitle">Join thousands of creators and businesses using Dzine.ai today</p>
      <button class="btn-primary btn-large">Start Creating for Free</button>
    ...
    <div class="pre-footer">
      <div class="container">
        <h2 class="pre-footer-title">Create Your First Project in Dzine</h2>
        <button class="btn-primary btn-large">Start for Free</button>
      </div>
    </div>
...
const tabs = ref([
  {
    ...
    description: "With Dzine (formerly Stylar AI)'s diverse art styles and AI-assisted tools, designers can quickly create and customize characters for animations and games, including the conversion of 2D sketches into dynamic 3D characters.",
    images: [
  ...
  },
  {
    ...
    description: "Dzine's AI tools make it easy to design custom patterns, graphics and artwork for print-on-demand products like t-shirts, mugs, and posters, allowing creators to quickly generate marketable designs without extensive graphic design experience.",
    images: [
  ...
  },
  {
    ...
    description: "Transform basic product photos into professional marketing assets with Dzine's background replacement, lighting enhancement, and composition tools. Create consistent brand imagery across your entire product catalog without expensive photo shoots.",
    images: [
  ...
  },
  {
    ...
    description: "Game developers can accelerate production by using Dzine to generate textures, environment elements, character concepts, and UI components. The AI-powered tools help maintain visual consistency while reducing development time and costs.",
    images: [
  ...
  },
  {
    ...
    description: "Interior designers can use Dzine to visualize room transformations, test different color schemes, furniture arrangements, and design elements before implementation. Create photorealistic renders of spaces from simple sketches or existing photos.",
    images: [
  ...
  },
  {
    ...
    description: "Marketers can quickly create professional social media posts, ads, banners, and promotional materials with Dzine. The AI tools help maintain brand consistency while allowing for rapid production of various marketing assets across campaigns.",
    images: [
...
.vi {
  ...
  --er: 71.76% .221 22.18;
  --bc: 83.825% 0 0;
  --pc: 17.617% .036117 94.020264;
  --sc: 17.6992% .028367 95.291946;
  --ac: 15.3748% .024689 184.972959;
  --nc: 87.7082% .004808 262.829219;
  --inc: 0% 0 0;
  --suc: 0% 0 0;
  --wac: 0% 0 0;
  --erc: 0% 0 0;
  ...
  --tab-border: 1px;
  --tab-radius: .5rem;
  --s: 88.4962% .141836 95.291946;
  --a: 76.8742% .123447 184.972959;
  --n: 38.5412% .024038 262.829219;
  --b1: 19.1251% 0 0;
  --rounded-btn: .3rem;
  --tw-text-opacity: 1;
